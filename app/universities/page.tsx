        ...
        <div className="container-custom">
          ...
          <div className="mb-6">
            <p className="text-gray-600">
              Showing <span className="font-semibold text-gray-900">{filteredUniversities.length}</span> universities
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredUniversities.map((university) => (
              <div
                key={university.id}
                className="university-card bg-white rounded-2xl shadow-card overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-100"
              >
                <div className="h-40 bg-gradient-to-br from-primary-100 to-secondary-100 flex items-center justify-center p-6 relative">
                  <div className="w-24 h-24 bg-white rounded-2xl shadow-soft flex items-center justify-center text-4xl">
                    🎓
                  </div>
